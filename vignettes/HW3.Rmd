...
# error: 'generate_partial_clique' is not an exported object from 'namespace:UWBiost561'
# solution: use devtools::document() to update the document
simulation$adj_mat
```
...
I do not have any specific topic for my final project in mind, but I think I would like to write a small useful function for data-processing (e.g. pivot_longer). I do not know if this is duable or not, but I will wait for the instructions. 
